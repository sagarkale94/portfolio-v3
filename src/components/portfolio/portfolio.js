...
import SW from "../../assets/images/ic_project/sw.png";
...
function Portfolio() {
    ...
    return (
        <div data-aos="fade-right" className="page-container">
            <Helmet>
                <title>Work | Sagar - Portfolio</title>
                <meta
                    name="description"
                    content="Sagar Kale's worked on projects"
                />
            </Helmet>
            <Title
                bgTitle="works"
                    ...
                    <div className="row top-20">
                        ...
                        <div className="col-md-4 col-xs-12">
                            <div className="grid-item-outer">
                                <div
                                    className="grid-item"
                                    style={{ backgroundImage: `url(${Brigs})` }}
                                >
                                    <div
                                        className="overlay"
                        ...
                        <div className="col-md-4 col-xs-12">
                            <div className="grid-item-outer">
                                <div
                                    className="grid-item"
                                    style={{ backgroundImage: `url(${Fitke})` }}
                                >
                                    <div
                                        className="overlay"
                    ...
                    <div className="row top-20">
                        ...
                        <div className="col-md-4 col-xs-12">
                            <div className="grid-item-outer">
                                <div
                                    className="grid-item"
                                    style={{ backgroundImage: `url(${Ikshu})` }}
                                >
                                    <div
                                        className="overlay"
                        ...
                        <div className="col-md-4 col-xs-12">
                            <div className="grid-item-outer">
                                <div
                                    className="grid-item"
                                    style={{ backgroundImage: `url(${Lagna})` }}
                                >
                                    <div
                                        className="overlay"
